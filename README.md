...
苦累蛙圓體是[紅道字體](https://github.com/davelab6/Zen-Project)的補字計畫。。與原作者的主要差異是調整部件寫法、新增中文字、增加為5個字重、增加一些符號。可以免費商用，歡迎大家自由應用、自由優化、自由改作！
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/kurewa-gothic@1.000/webfont/CJK%20TC/KurewaGothicCjkTc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/kurewa-gothic@1.000/webfont/CJK%20TC/KurewaGothicCjkTc-Regular.woff) format("woff");
}
```
